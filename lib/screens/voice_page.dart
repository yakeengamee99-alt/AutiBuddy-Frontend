...
import 'voice_page2.dart';

class LionScreen extends StatefulWidget {
  const LionScreen({super.key});

  @override
  State<LionScreen> createState() => _LionScreenState();
}
...
class _LionScreenState extends State<LionScreen> {
  ...
  // مهم: غيري الرقم ده حسب ID كلمة Lion في GET /api/ContentItems
  static const int apiContentItemId = 1;

  Future<void> speakLion() async {
    await tts.setLanguage("en-US");
    await tts.setSpeechRate(0.5);
    await tts.setPitch(1.0);
    await tts.speak("Lion");
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Lion، خليها speakLion();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Lion، خليها speakLion();
                  },
                  child: const Text(
                    'The Lion',
                    style: TextStyle(
