...
import 'number_page3.dart';

class NumbersPage2 extends StatelessWidget {
  const NumbersPage2({super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildItem("FIVE", 'assets/images/5.jpg', context),
              buildItem("TWO", 'assets/images/2.jpg', context),
              buildItem("SEVEN", 'assets/images/7.jpg', context),
      ...
      onTap: () async {
        if (text == "TWO") {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const NumbersPage3(),
            ),
          );
        } else {
