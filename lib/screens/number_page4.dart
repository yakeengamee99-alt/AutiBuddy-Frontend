...
import 'number_page5.dart';

class NumbersPage4 extends StatelessWidget {
  const NumbersPage4({super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildItem("NINE", 'assets/images/8.jpg', context),
      ...
      onTap: () async {
        if (text == "FOUR") {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const NumbersPage5(),
            ),
          );
        } else {
