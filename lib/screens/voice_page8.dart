...
class TomatoScreen extends StatefulWidget {
  ...
  @override
  State<TomatoScreen> createState() => _TomatoScreenState();
}
...
class _TomatoScreenState extends State<TomatoScreen> {
  ...
  // غيّري الرقم لو Tomato في Swagger له ID مختلف
  static const int apiContentItemId = 8;

  Future<void> speakTomato() async {
    await tts.setLanguage("en-US");
    await tts.setSpeechRate(0.5);
    await tts.setPitch(1.0);
    await tts.speak("Tomato");
  }
  ...
  Future<void> startRecording() async {
    ...
    setState(() {
      isRecording = true;
      statusText = "Recording... say Tomato";
    });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Tomato اكتبي هنا:
                    // speakTomato();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Tomato اكتبي هنا:
                    // speakTomato();
                  },
                  child: const Text(
                    'The Tomato',
                ...
                // زرار Play sound ينطق Tomato
                SizedBox(
                  width: 250,
                  height: 55,
                  child: ElevatedButton(
                    onPressed: speakTomato,
                    style: ElevatedButton.styleFrom(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const BananaScreen(),
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
