...
import 'number_page7.dart';

class NumbersPage6 extends StatelessWidget {
  const NumbersPage6({super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildItem("SIX", 'assets/images/6.jpg', context),
      ...
      onTap: () async {
        if (text == "SIX") {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const NumbersPage7(),
            ),
          );
        } else {
