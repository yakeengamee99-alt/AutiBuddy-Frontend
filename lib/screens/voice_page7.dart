...
class _FishScreenState extends State<FishScreen> {
  ...
  // غيّري الرقم لو Fish في Swagger له ID مختلف
  static const int apiContentItemId = 7;

  Future<void> speakFish() async {
    await tts.setLanguage("en-US");
    await tts.setSpeechRate(0.5);
    await tts.setPitch(1.0);
    await tts.speak("Fish");
  }
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Fish اكتبي هنا:
                    // speakFish();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Fish اكتبي هنا:
                    // speakFish();
                  },
                  child: const Text(
                    'The Fish',
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const TomatoScreen(),
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
