...
class _DogScreenState extends State<DogScreen> {
  ...
  // Dog في Swagger رقمه 2
  static const int apiContentItemId = 2;

  Future<void> speakDog() async {
  ...
  Future<void> uploadAudio() async {
    ...
    try {
      ...
      final formData = FormData.fromMap({
        ...
        "File": MultipartFile.fromBytes(recordedWavBytes!, filename: "dog.wav"),
      });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Dog، خليها speakDog();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Dog، خليها speakDog();
                  },
                  child: const Text(
                    'The Dog',
                    style: TextStyle(
