...
class GiraffeScreen extends StatefulWidget {
  const GiraffeScreen({super.key});

  @override
  State<GiraffeScreen> createState() => _GiraffeScreenState();
}

class _GiraffeScreenState extends State<GiraffeScreen> {
  ...
  // موجود عندك في Firebase باسم apiChildId
  static const int apiChildId = 4;

  // غيّري الرقم لو Giraffe في Swagger له ID مختلف
  static const int apiContentItemId = 5;

  Future<void> speakGiraffe() async {
    await tts.setLanguage("en-US");
    await tts.setSpeechRate(0.5);
    await tts.setPitch(1.0);
    await tts.speak("Giraffe");
  }
  ...
  Future<void> startRecording() async {
    ...
    setState(() {
      isRecording = true;
      statusText = "Recording... say Giraffe";
    });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Giraffe اكتبي هنا: speakGiraffe();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Giraffe اكتبي هنا: speakGiraffe();
                  },
                  child: const Text(
                    'The Giraffe',
                    style: TextStyle(
                ...
                // زرار Play sound ينطق Giraffe
                SizedBox(
                  width: 250,
                  height: 55,
                  child: ElevatedButton(
                    onPressed: speakGiraffe,
                    style: ElevatedButton.styleFrom(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const MonkeyScreen(),
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
