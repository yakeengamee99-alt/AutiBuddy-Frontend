...
class MonkeyScreen extends StatefulWidget {
  const MonkeyScreen({super.key});

  @override
  State<MonkeyScreen> createState() => _MonkeyScreenState();
}

class _MonkeyScreenState extends State<MonkeyScreen> {
  ...
  // غيّري الرقم لو Monkey في Swagger له ID مختلف
  static const int apiContentItemId = 6;

  Future<void> speakMonkey() async {
    await tts.setLanguage("en-US");
    await tts.setSpeechRate(0.5);
    await tts.setPitch(1.0);
    await tts.speak("Monkey");
  }
  ...
  Future<void> startRecording() async {
    ...
    setState(() {
      isRecording = true;
      statusText = "Recording... say Monkey";
    });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Monkey اكتبي هنا:
                    // speakMonkey();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Monkey اكتبي هنا:
                    // speakMonkey();
                  },
                  child: const Text(
                    'The Monkey',
                ...
                // زرار Play sound ينطق Monkey
                SizedBox(
                  width: 250,
                  height: 55,
                  child: ElevatedButton(
                    onPressed: speakMonkey,
                    style: ElevatedButton.styleFrom(
