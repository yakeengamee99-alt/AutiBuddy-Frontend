...
import 'number_page6.dart';

class NumbersPage5 extends StatelessWidget {
  const NumbersPage5({super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildItem("ONE", 'assets/images/1.jpg', context),
      ...
      onTap: () async {
        if (text == "FIVE") {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const NumbersPage6(),
            ),
          );
        } else {
