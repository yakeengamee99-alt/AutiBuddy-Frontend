...
import 'fv_page7.dart';

class FVPage6 extends StatelessWidget {
  const FVPage6({super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildItem("Potato", 'assets/images/potato.jpg', context),
              buildItem("Orange", 'assets/images/orange.jpg', context),
