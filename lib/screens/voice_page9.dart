...
class BananaScreen extends StatefulWidget {
  ...
  @override
  State<BananaScreen> createState() => _BananaScreenState();
}
...
class _BananaScreenState extends State<BananaScreen> {
  ...
  // غيّري الرقم لو Banana في Swagger له ID مختلف
  static const int apiContentItemId = 9;

  Future<void> speakBanana() async {
    await tts.setLanguage("en-US");
    await tts.setSpeechRate(0.5);
    await tts.setPitch(1.0);
    await tts.speak("Banana");
  }
  ...
  Future<void> startRecording() async {
    ...
    setState(() {
      isRecording = true;
      statusText = "Recording... say Banana";
    });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Banana اكتبي هنا:
                    // speakBanana();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Banana اكتبي هنا:
                    // speakBanana();
                  },
                  child: const Text(
                    'The Banana',
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const CucumberScreen(),
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
