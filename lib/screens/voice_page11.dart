...
class StrawberryScreen extends StatefulWidget {
  ...
  @override
  State<StrawberryScreen> createState() => _StrawberryScreenState();
}

class _StrawberryScreenState extends State<StrawberryScreen> {
  ...
  // غيّري الرقم لو Strawberry في Swagger له ID مختلف
  static const int apiContentItemId = 11;

  Future<void> speakStrawberry() async {
    await tts.setLanguage("en-US");
    await tts.setSpeechRate(0.5);
    await tts.setPitch(1.0);
    await tts.speak("Strawberry");
  }
  ...
  Future<void> startRecording() async {
    ...
    setState(() {
      isRecording = true;
      statusText = "Recording... say Strawberry";
    });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Strawberry اكتبي هنا:
                    // speakStrawberry();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Strawberry اكتبي هنا:
                    // speakStrawberry();
                  },
                  child: const Text(
                    'The Strawberry',
                ...
                // زرار Play sound ينطق Strawberry
                SizedBox(
                  width: 250,
                  height: 55,
                  child: ElevatedButton(
                    onPressed: speakStrawberry,
                    style: ElevatedButton.styleFrom(
