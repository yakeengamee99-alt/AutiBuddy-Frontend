...
import 'number_page8.dart';

class NumbersPage7 extends StatelessWidget {
  const NumbersPage7({super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildItem("TEN", 'assets/images/10.jpg', context),
      ...
      onTap: () async {
        if (text == "SEVEN") {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const NumbersPage8(),
            ),
          );
        } else {
