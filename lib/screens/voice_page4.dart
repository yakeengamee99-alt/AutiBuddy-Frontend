...
class ElephantScreen extends StatefulWidget {
  ...
  @override
  State<ElephantScreen> createState() => _ElephantScreenState();
}
...
class _ElephantScreenState extends State<ElephantScreen> {
  ...
  // غيّري الرقم لو Elephant في Swagger له ID مختلف
  static const int apiContentItemId = 4;

  Future<void> speakElephant() async {
    await tts.setLanguage("en-US");
    await tts.setSpeechRate(0.5);
    await tts.setPitch(1.0);
    await tts.speak("Elephant");
  }
  ...
  Future<void> startRecording() async {
    ...
    setState(() {
      isRecording = true;
      statusText = "Recording... say Elephant";
    });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Elephant اكتبي هنا: speakElephant();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Elephant اكتبي هنا: speakElephant();
                  },
                  child: const Text(
                    'The Elephant',
                    style: TextStyle(
                ...
                // زرار Play sound ينطق Elephant
                SizedBox(
                  width: 250,
                  height: 55,
                  child: ElevatedButton(
                    onPressed: speakElephant,
                    style: ElevatedButton.styleFrom(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const GiraffeScreen(),
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
