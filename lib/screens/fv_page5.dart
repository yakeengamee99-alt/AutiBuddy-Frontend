...
import 'fv_page6.dart';

class FVPage5 extends StatelessWidget {
  const FVPage5({super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildItem("Banana", 'assets/images/banana.jpg', context),
              buildItem("Watermelon", 'assets/images/watermelon.jpg', context),
              buildItem("Tomato", 'assets/images/tomato.jpg', context),
