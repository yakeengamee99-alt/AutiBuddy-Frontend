...
class _CatScreenState extends State<CatScreen> {
  ...
  // غيّري الرقم لو Cat في Swagger له ID مختلف
  static const int apiContentItemId = 3;

  Future<void> speakCat() async {
  ...
  Future<void> uploadAudio() async {
    ...
    try {
      ...
      final formData = FormData.fromMap({
        ...
        "File": MultipartFile.fromBytes(recordedWavBytes!, filename: "cat.wav"),
      });
          ...
          child: Padding(
            ...
            child: Column(
              ...
              children: [
                ...
                ElevatedButton(
                  onPressed: () {
                    // لو عايزة الصورة كمان تنطق Cat اكتبي هنا: speakCat();
                  },
                ...
                TextButton(
                  onPressed: () {
                    // لو عايزة الكلمة كمان تنطق Cat اكتبي هنا: speakCat();
                  },
                  child: const Text(
                    'The Cat',
                    style: TextStyle(
                      ...
                      child: ElevatedButton(
                        onPressed: () {
                          Navigator.push(
                            context,
                            MaterialPageRoute(
                              builder: (context) => const ElephantScreen(),
                            ),
                          );
                        },
                        style: ElevatedButton.styleFrom(
