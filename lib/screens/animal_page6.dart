...
import 'animal_page7.dart';

class AnimalPage6 extends StatelessWidget {
  const AnimalPage6({super.key});
        ...
        child: Container(
          ...
          child: Column(
            ...
            children: [
              ...
              buildItem("Monkey", 'assets/images/monkey.jpg', context),
              buildItem("Elephant", 'assets/images/elephant.jpg', context),
              buildItem("Lion", 'assets/images/lion.jpg', context),
      ...
      onTap: () async {
        if (text == "Lion") {
          ...
          Navigator.push(
            context,
            MaterialPageRoute(
              builder: (context) => const AnimalPage7(),
            ),
          );
        } else {
